            ...
            <div class="col s10 m10 l10 offset-s1 offset-m1 offset-l1">
                <div id="profile-page" class="section">
                    <div id="profile-page-header" class="card">
                        ...
                        <div class="progress" id="load-progress-foto" style="margin: 0 0 0 0;display:none">
                            <div class="indeterminate"></div>
                        </div>
                        <figure class="card-profile-image" style="top:290px;">
                            <div class="center-cropped-large">
                                <?php if (empty($val->img_admin)): ?>
                                    <img class="circle z-depth-2 responsive-img activator" src="<?php echo base_url('assets/document/style/img/logo_kota_tegal.png')?>" alt="profile image">
                                <?php else: ?>
                                    <img class="circle z-depth-2 responsive-img activator" src="<?php echo base_url('assets/document/img/admin/'.$val->img_admin)?>" alt="profile image">
                                <?php endif; ?>
                            </div>
                            <a class="btn-floating btn-large waves-effect waves-light light-blue right modal-trigger" href="#modal_dialog"
                               style="margin: -35% -18% 0 0;" onclick="modal('ubah_foto_admin')">
                    ...
                    <div id="profile-page-sidebar" class="col s12 m4">
                        <div class="card">
                            <div class="card-image profile-large">
                                ...
                                <div class="progress" id="load-progress-gallery" style="margin: 0 0 0 0;display:none">
                                    <div class="indeterminate" id="progressBar"></div>
                                </div>
                                <div class="card-content">
                                    <a class="btn-floating btn-move-up waves-effect waves-light light-blue right modal-trigger" href="#modal_dialog"
                                       onclick="modal('tambah_gallery_admin')">
                        ...
                        <div class="card">
                            ...
                            <div class="progress" id="load-progress-deskripsi" style="margin: 0 0 0 0;display:none;">
                                <div class="indeterminate" id="progressBar"></div>
                            </div>
                            <div class="card-content">
                                <p><?php echo $val->deskripsi_admin; ?></p>
                                <a class="btn-floating btn-move-up waves-effect waves-light light-blue right modal-trigger" href="#modal_dialog"
                                   onclick="modal('ubah_deskripsi_admin')">
                        ...
                        <div class="map-card">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <a class="btn-floating btn-move-up waves-effect waves-light light-blue right modal-trigger" onclick="mapAduan('<?php echo $val->lati;?>','<?php echo $val->longi;?>','<?php echo $val->id_tb_admin;?>')">
                                        <i class="material-icons">edit_location</i>
                                    </a>
                                    <h4 class="card-title grey-text text-darken-4"><a href="#" class="grey-text text-darken-4">Peta</a>
                                    </h4>
                                    <p class="blog-post-content">Lokasi Instansi.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col s1">
                                                <div class="center-cropped-small">
                                                    <?php if (empty($val->img_admin)): ?>
                                                        <img class="circle responsive-img valign profile-post-uer-image" src="<?php echo base_url('assets/document/style/img/logo_kota_tegal.png')?>" alt="profile image">
                                                    <?php else: ?>
                                                        <img class="circle responsive-img valign profile-post-uer-image" src="<?php echo base_url('assets/document/img/admin/'.$val->img_admin)?>" alt="profile image">
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="col s10">
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <button type="button" class="btn-floating waves-effect waves-light red right modal-trigger"
                                                                    onclick="modal('ubah_password_admin')"><i class="material-icons">lock</i></button>
...
<script type="text/javascript">
    ...
    function modal(str) {
        if (str=="ubah_foto_admin") {
            $('#load-progress-foto').show();
        } else if (str=="ubah_deskripsi_admin") {
            $('#load-progress-deskripsi').show();
        } else if (str=="tambah_gallery_admin") {
            $('#load-progress-gallery').show();
        } else if (str=="ubah_password_admin") {
    ...
    function hideProgress() {
        $('#load-progress-foto').hide();
        $('#load-progress-deskripsi').hide();
        $('#load-progress-gallery').hide();
    ...
    $(function() {
        $("#formValidate").validate({
            ...
            submitHandler: function(form) {
                ...
                $('#load-progress-profil').show();
                $.ajax({
                    type: "POST",data:values,url: "<?php echo base_url('Admin/ubah_profil_admin'); ?>",
                    success: function(data)
                    {
                        $('#load-progress-profil').hide();
                        if (data==1) {
    ...
    function mapAduan(lati,longi,id) {
        $('#load-progress-navbar').show();
        var str="map_profil";
        $.ajax(
            {
                type: "GET",
                data:{type:str,lati:lati,longi:longi,id:id},
                url: "<?php echo base_url('Admin/modal'); ?>",
                success: function(data)
                {
